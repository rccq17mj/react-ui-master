...
export default class PerfSwitch extends React.Component {
  constructor (props) {
    super(props);
    this.state = {
      isTest: false
  ...
  render () {
    if (!perf) {
      ...
      this.props.left ? style.left = 5 : style.right = 5;
      this.props.top ? style.top = 5 : style.bottom = 5;

      return (
        <a href="javascript:;" onClick={this.handleToggle}
          style={{ position: 'fixed', right: 5, bottom: 5, opacity: 0.5 }}>
...
PerfSwitch.propTypes = {
  left: PropTypes.bool,
  top: PropTypes.bool,
  printInclusive: PropTypes.bool,
  printOperations: PropTypes.bool,
  printWasted: PropTypes.bool
}

PerfSwitch.defaultProps = {
  printInclusive: true
}
